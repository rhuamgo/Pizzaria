...
def abrir_TipoPedido(janela, janelaIncial):
 ...
 def entrega():
     janela_pedido.withdraw()
     tela_final.finalizarPedido(janela_pedido, 'Entrega', janelaIncial)

 def retirada():
     janela_pedido.withdraw()
     tela_final.finalizarPedido(janela_pedido, 'Retirada', janelaIncial)
 ...
 botao_entrega = tk.Button(frame1, text="Entrega", image=janela_pedido.img_entrega, compound="top",
                          bd=3, bg="#d72e4c", fg="black", font=("verdana", 8, "bold"), command=entrega)
 ...
 botao_entrega = tk.Button(frame1, text="Retirada", image=janela_pedido.img_retire, compound="top",
                          bd=3, bg="#d72e4c", fg="black", font=("verdana", 8, "bold"), command=retirada)
 botao_entrega.pack(padx=10, pady=10)
